...
<style>
  ...
  .sv-c-inc { font-size: 10.5px; color: #a66; padding: 5px 6px; margin-bottom: 3px; background: rgba(200,85,85,0.05); border-radius: 3px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: block; }
